...
$data['imagen_pieza']=(isset($_FILES['imagen_pieza']))?"assets/public/img/logos/{$_FILES['imagen_pieza']['name']}":'';
move_uploaded_file($_FILES['imagen_pieza']['tmp_name'], "assets/public/img/logos/{$_FILES['imagen_pieza']['name']}");
