...
<?php while($resDatos = $database->recorrer($consulta)):?>
					<li>
						...
						<h4><?php echo $resDatos["nombre_lugar"];?><i class="pending"><?php echo $resDatos["estado_reserva"];?></i></h4>
						<ul class="booking_list">
							<li><strong>Fecha de Reserva</strong> <?php $resDatos["fecha"];?></li>
							<li><strong>Booking details</strong> <?php $resDatos["cantidad_personas"];?></li>
							<li><strong>Client</strong> <?php $resDatos["nombre_reserva"];?></li>
            </ul>
